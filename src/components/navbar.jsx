...
const navbar = () => {
  ...
  return (
    <div className="Container p-3 flex h-[80px] items-center shadow-black  shadow-2xl">
      <div className="navbar-item-logo cursor-pointer"  >
        <a className="  text-white text-4xl ml-3 font-semibold " href="/">
          Passify
      ...
      <div className="main container flex items-center  justify-center min-lg:mr-30">
